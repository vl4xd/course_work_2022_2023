...
namespace medical_family_card.Models
{
    public static class DiseaseModel
    {
        ...
        public static string Disease_Name { get; set; }
        ...
        public static int CountPhoto(int id)
        {
            ...
            using (var command = new SqlCommand())
            {
                ...
                command.CommandText = "SELECT COUNT(*) AS count_photo FROM photo_about_diseases WHERE disease_id=@id";
        ...
        public static void DeleteAllPhoto(int id)
        {
            ...
            using (var command = new SqlCommand())
            {
                ...
                command.Connection = connection;
                command.CommandText =
                    $"DELETE FROM photo_about_diseases " +
                    "WHERE " +
                    $"disease_id=@id";
                command.Parameters.Add("@id", SqlDbType.Int).Value = id;
